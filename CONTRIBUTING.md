...
4. Update documentation
   - Ensure the language appears in `docs/supported-languages.md`
   - No changes to `docs/readme-languages-template.md` are needed; it is generated from the supported list
