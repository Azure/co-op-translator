...
Maintainers: Copy the block below into your repository's `README.md`. Remove any languages you don't plan to support or that haven't been generated yet. Links point to `./translations/<code>/README.md` created by Co-op Translator.

```markdown

### 🌐 Multi-Language Support

#### Supported via Co-op Translator (Automated & Always Up-to-Date)
