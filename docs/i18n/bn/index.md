<section class="home-hero">
  <p class="home-eyebrow">শুরু করুন</p>
  <h1>Co-op Translator ডকুমেন্টেশন</h1>
  <p class="home-lede">
    একটি LLM প্রদানকারী কনফিগার করুন, আপনার লক্ষ্য ভাষাগুলি নির্বাচন করুন, এবং সোর্স পরিবর্তিত হওয়ার সাথে সাথে প্রকল্প কনটেন্ট অনুবাদ ও পর্যালোচনার জন্য CLI, Python API, বা MCP সার্ভার থেকে Co-op Translator ব্যবহার করুন।
  </p>
  <a class="home-link" href="workflows/">আপনার ওয়ার্কফ্লো নির্বাচন করুন -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">ধাপ 1</span>
    <strong>আপনার প্রকল্প কনফিগার করুন</strong>
    <span>প্রোভাইডার, ক্রেডেনশিয়াল, লক্ষ্য ভাষা, এবং আউটপুট ডিরেক্টরি সেট আপ করুন।</span>
    <em>গাইড পড়ুন -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">ধাপ 2</span>
    <strong>CLI দিয়ে অনুবাদ করুন</strong>
    <span>অনুবাদ, মূল্যায়ন, পর্যালোচনা, এবং লিঙ্ক মাইগ্রেশন কমান্ড চালান।</span>
    <em>গাইড পড়ুন -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">ধাপ 3</span>
    <strong>Python API দিয়ে স্বয়ংক্রিয় করুন</strong>
    <span>স্ক্রিপ্ট এবং অটোমেশন ওয়ার্কফ্লো থেকে Co-op Translator ব্যবহার করুন।</span>
    <em>গাইড পড়ুন -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">ধাপ 4</span>
    <strong>MCP সার্ভারের সাথে সংযোগ করুন</strong>
    <span>Co-op Translator টুলগুলো এজেন্ট, সম্পাদক, এবং MCP-সামঞ্জস্যপূর্ণ ক্লায়েন্টদের কাছে প্রকাশ করুন।</span>
    <em>গাইড পড়ুন -></em>
  </a>
</div>