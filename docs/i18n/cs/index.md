<section class="home-hero">
  <p class="home-eyebrow">Začínáme</p>
  <h1>Dokumentace Co-op Translatoru</h1>
  <p class="home-lede">
    Nakonfigurujte poskytovatele LLM, zvolte cílové jazyky a používejte Co-op Translator z CLI, Python API nebo MCP serveru k překládání a kontrole obsahu projektu při změnách zdroje.
  </p>
  <a class="home-link" href="workflows/">Vyberte pracovní postup -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    ...
    <strong>Nakonfigurujte svůj projekt</strong>
    <span>Nastavte poskytovatele, přihlašovací údaje, cílové jazyky a výstupní adresáře.</span>
    <em>Přečtěte si průvodce -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Krok 2</span>
    <strong>Překládejte pomocí CLI</strong>
    <span>Spouštějte příkazy pro překlad, hodnocení, revizi a migraci odkazů.</span>
    <em>Přečtěte si průvodce -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Krok 3</span>
    <strong>Automatizujte pomocí Python API</strong>
    <span>Používejte Co-op Translator ve skriptech a automatizačních pracovních postupech.</span>
    <em>Přečtěte si průvodce -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Krok 4</span>
    <strong>Připojte se k serveru MCP</strong>
    <span>Zpřístupněte nástroje Co-op Translator agentům, editorům a klientům kompatibilním s MCP.</span>
    <em>Přečtěte si průvodce -></em>
  </a>
</div>