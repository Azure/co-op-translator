<section class="home-hero">
  <p class="home-eyebrow">Kom godt i gang</p>
  <h1>Co-op Translator-dokumentation</h1>
  <p class="home-lede">
    Konfigurer en LLM-udbyder, vælg dine målsprog, og brug Co-op
    Translator fra CLI, Python API eller MCP-serveren til at oversætte og gennemse
    projektindhold, mens kilden ændrer sig.
  </p>
  <a class="home-link" href="workflows/">Vælg din arbejdsgang -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Trin 1</span>
    <strong>Konfigurer dit projekt</strong>
    <span>Opsæt udbydere, legitimationsoplysninger, målsprog og outputmapper.</span>
    <em>Læs vejledningen -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Trin 2</span>
    <strong>Oversæt med CLI</strong>
    <span>Kør kommandoer til oversættelse, evaluering, gennemgang og linkmigrering.</span>
    <em>Læs vejledningen -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Trin 3</span>
    <strong>Automatisér med Python-API'en</strong>
    <span>Brug Co-op Translator fra scripts og automatiseringsarbejdsgange.</span>
    <em>Læs vejledningen -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Trin 4</span>
    <strong>Forbind til MCP-serveren</strong>
    <span>Gør Co-op Translator-værktøjer tilgængelige for agenter, redaktører og MCP-kompatible klienter.</span>
    <em>Læs vejledningen -></em>
  </a>
</div>