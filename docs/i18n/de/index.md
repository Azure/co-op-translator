<section class="home-hero">
  <p class="home-eyebrow">Erste Schritte</p>
  <h1>Co-op Translator Dokumentation</h1>
  <p class="home-lede">
    Konfigurieren Sie einen LLM-Anbieter, wählen Sie Ihre Zielsprache(n) und verwenden Sie Co-op
    Translator über die CLI, die Python-API oder den MCP-Server, um Projektinhalte zu übersetzen und zu überprüfen
    während sich die Quelle ändert.
  </p>
  <a class="home-link" href="workflows/">Wählen Sie Ihren Workflow -></a>
</section>
...
Diese `docs/` Seiten sind die kanonische Co-op Translator Dokumentation. Ältere Einrichtungsanleitungen wurden hier zusammengeführt, damit CLI, API, MCP, CI und Anleitungen zur Fehlerbehebung an einem Ort bleiben.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Schritt 1</span>
    <strong>Projekt konfigurieren</strong>
    <span>Richten Sie Anbieter, Anmeldeinformationen, Zielsprache(n) und Ausgabeverzeichnisse ein.</span>
    <em>Leitfaden lesen -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Schritt 2</span>
    <strong>Mit CLI übersetzen</strong>
    <span>Führen Sie Befehle für Übersetzung, Bewertung, Überprüfung und Link-Migration aus.</span>
    <em>Leitfaden lesen -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Schritt 3</span>
    <strong>Automatisieren mit der Python-API</strong>
    <span>Verwenden Sie Co-op Translator in Skripten und Automatisierungs-Workflows.</span>
    <em>Leitfaden lesen -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Schritt 4</span>
    <strong>Mit dem MCP-Server verbinden</strong>
    <span>Stellen Sie Co-op Translator-Tools Agenten, Redakteuren und MCP-kompatiblen Clients zur Verfügung.</span>
    <em>Leitfaden lesen -></em>
  </a>
</div>