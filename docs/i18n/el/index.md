<section class="home-hero">
  <p class="home-eyebrow">Ξεκινώντας</p>
  <h1>Τεκμηρίωση Co-op Translator</h1>
  <p class="home-lede">
    Ρυθμίστε έναν πάροχο LLM, επιλέξτε τις γλώσσες-στόχους σας και χρησιμοποιήστε το Co-op
    Translator από το CLI, το Python API ή τον διακομιστή MCP για να μεταφράσετε και να ελέγξετε
    το περιεχόμενο του έργου καθώς αλλάζει η πηγή.
  </p>
  <a class="home-link" href="workflows/">Επιλέξτε τη ροή εργασίας σας -></a>
</section>
...
Αυτές οι σελίδες `docs/` είναι η επίσημη τεκμηρίωση του Co-op Translator. Παλαιότεροι οδηγοί ρύθμισης έχουν ενοποιηθεί εδώ ώστε οι οδηγίες για CLI, API, MCP, CI και αντιμετώπιση προβλημάτων να παραμένουν σε ένα μέρος.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Βήμα 1</span>
    <strong>Ρυθμίστε το έργο σας</strong>
    <span>Ρυθμίστε παρόχους, διαπιστευτήρια, γλώσσες-στόχους και καταλόγους εξόδου.</span>
    <em>Διαβάστε τον οδηγό -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Βήμα 2</span>
    <strong>Μετάφραση με το CLI</strong>
    <span>Εκτελέστε εντολές μετάφρασης, αξιολόγησης, αναθεώρησης και μετανάστευσης συνδέσμων.</span>
    <em>Διαβάστε τον οδηγό -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Βήμα 3</span>
    <strong>Αυτοματοποιήστε με το Python API</strong>
    <span>Χρησιμοποιήστε το Co-op Translator από σενάρια και ροές εργασίας αυτοματοποίησης.</span>
    <em>Διαβάστε τον οδηγό -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Βήμα 4</span>
    <strong>Συνδεθείτε με τον διακομιστή MCP</strong>
    <span>Κάντε διαθέσιμα τα εργαλεία Co-op Translator σε πράκτορες, συντάκτες και πελάτες συμβατούς με MCP.</span>
    <em>Διαβάστε τον οδηγό -></em>
  </a>
</div>