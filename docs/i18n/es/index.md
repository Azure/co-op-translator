<section class="home-hero">
  <p class="home-eyebrow">Primeros pasos</p>
  <h1>Documentación de Co-op Translator</h1>
  <p class="home-lede">
    Configura un proveedor de LLM, elige tus idiomas de destino y usa Co-op
    Translator desde la CLI, la API de Python o el servidor MCP para traducir y revisar
    el contenido del proyecto a medida que cambia la fuente.
  </p>
  <a class="home-link" href="workflows/">Elige tu flujo de trabajo -></a>
</section>
...
Estas `docs/` páginas son la documentación canónica de Co-op Translator. Las guías de configuración antiguas se han consolidado aquí para que CLI, API, MCP, CI, y la orientación de resolución de problemas estén en un solo lugar.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Paso 1</span>
    <strong>Configura tu proyecto</strong>
    <span>Configura proveedores, credenciales, idiomas de destino y directorios de salida.</span>
    <em>Lee la guía -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Paso 2</span>
    <strong>Traduce con la CLI</strong>
    <span>Ejecuta comandos de traducción, evaluación, revisión y migración de enlaces.</span>
    <em>Lee la guía -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Paso 3</span>
    <strong>Automatiza con la API de Python</strong>
    <span>Usa Co-op Translator desde scripts y flujos de trabajo de automatización.</span>
    <em>Lee la guía -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Paso 4</span>
    <strong>Conéctate con el servidor MCP</strong>
    <span>Expón las herramientas de Co-op Translator a agentes, editores y clientes compatibles con MCP.</span>
    <em>Lee la guía -></em>
  </a>
</div>