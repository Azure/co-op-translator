<section class="home-hero">
  <p class="home-eyebrow">Alustamine</p>
  <h1>Co-op Translatori dokumentatsioon</h1>
  <p class="home-lede">
    Seadista LLM-pakkuja, vali sihtkeeled ja kasuta Co-op
    Translatorit CLI, Python API või MCP serveri kaudu projektisisu tõlkimiseks ja ülevaatamiseks
    kui lähteallikas muutub.
  </p>
  <a class="home-link" href="workflows/">Vali oma töövoog -></a>
</section>
...
Need `docs/` leheküljed on Co-op Translatori ametlik dokumentatsioon. Vanemad häälestusjuhendid on siin koondatud, nii et CLI-, API-, MCP-, CI- ja tõrkeotsingu juhised on ühes kohas.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Samm 1</span>
    <strong>Seadista oma projekt</strong>
    <span>Seadista teenusepakkujad, autentimisandmed, sihtkeeled ja väljundkaustad.</span>
    <em>Loe juhendit -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Samm 2</span>
    <strong>Tõlgi CLI abil</strong>
    <span>Käivita tõlke-, hindamis-, ülevaatamise- ja linkide migreerimise käsud.</span>
    <em>Loe juhendit -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Samm 3</span>
    <strong>Automatiseeri Python API abil</strong>
    <span>Kasuta Co-op Translatorit skriptides ja automatiseeritud töövoogudes.</span>
    <em>Loe juhendit -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Samm 4</span>
    <strong>Ühenda MCP Serveriga</strong>
    <span>Tee Co-op Translatori tööriistad kättesaadavaks agentidele, toimetajatele ja MCP-ühilduvatele klientidele.</span>
    <em>Loe juhendit -></em>
  </a>
</div>