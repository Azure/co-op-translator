<section class="home-hero">
  <p class="home-eyebrow">شروع به کار</p>
  <h1>مستندات Co-op Translator</h1>
  <p class="home-lede">
    پیکربندی یک ارائه‌دهنده LLM، انتخاب زبان‌های هدف خود، و استفاده از Co-op
    Translator از طریق CLI، API پایتون، یا سرور MCP برای ترجمه و بازبینی
    محتوای پروژه هنگام تغییر منبع.
  </p>
  <a class="home-link" href="workflows/">گردش کار خود را انتخاب کنید -></a>
</section>
...
این صفحات `docs/` مستندات مرجع Co-op Translator هستند. راهنمای راه‌اندازی قدیمی در اینجا تجمیع شده‌اند تا راهنمایی‌های CLI، API، MCP، CI، و عیب‌یابی در یک مکان باقی بمانند.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">مرحله 1</span>
    <strong>پیکربندی پروژهٔ خود</strong>
    <span>ارائه‌دهنده‌ها، اعتبارنامه‌ها، زبان‌های هدف، و دایرکتوری‌های خروجی را تنظیم کنید.</span>
    <em>راهنما را بخوانید -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">مرحله 2</span>
    <strong>با CLI ترجمه کنید</strong>
    <span>فرامین ترجمه، ارزیابی، بازبینی و مهاجرت لینک را اجرا کنید.</span>
    <em>راهنما را بخوانید -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">مرحله 3</span>
    <strong>خودکارسازی با API پایتون</strong>
    <span>از Co-op Translator در اسکریپت‌ها و گردش‌های کاری خودکار استفاده کنید.</span>
    <em>راهنما را بخوانید -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">مرحله 4</span>
    <strong>اتصال به سرور MCP</strong>
    <span>ابزارهای Co-op Translator را در اختیار عامل‌ها، ویرایشگران، و کلاینت‌های سازگار با MCP قرار دهید.</span>
    <em>راهنما را بخوانید -></em>
  </a>
</div>