<section class="home-hero">
  <p class="home-eyebrow">Aloittaminen</p>
  <h1>Co-op Translator -dokumentaatio</h1>
  <p class="home-lede">
    Määritä LLM-palveluntarjoaja, valitse kohdekielet ja käytä Co-op
    Translator CLI:n, Python-API:n tai MCP-palvelimen kautta kääntämään ja tarkistamaan
    projektin sisältöä lähdeaineiston muuttuessa.
  </p>
  <a class="home-link" href="workflows/">Valitse työnkulkusi -></a>
</section>
...
Nämä `docs/` sivut ovat virallinen Co-op Translator -dokumentaatio. Vanhemmat asennusohjeet on yhdistetty tähän, jotta CLI-, API-, MCP-, CI- ja vianmääritysopastus säilyvät yhdessä paikassa.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Vaihe 1</span>
    <strong>Määritä projektisi</strong>
    <span>Määritä palveluntarjoajat, tunnistetiedot, kohdekielet ja tuloskansiot.</span>
    <em>Lue opas -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Vaihe 2</span>
    <strong>Käännä CLI:llä</strong>
    <span>Suorita käännös-, arviointi-, tarkistus- ja linkkisiirtokomennot.</span>
    <em>Lue opas -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Vaihe 3</span>
    <strong>Automatisoi Python-API:lla</strong>
    <span>Käytä Co-op Translatoria skripteissä ja automaatiotyönkuluissa.</span>
    <em>Lue opas -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Vaihe 4</span>
    <strong>Yhdistä MCP-palvelimeen</strong>
    <span>Tarjoa Co-op Translatorin työkaluja agenteille, muokkaajille ja MCP-yhteensopiville asiakkaille.</span>
    <em>Lue opas -></em>
  </a>
</div>