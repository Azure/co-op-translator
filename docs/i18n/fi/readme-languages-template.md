...
Co-op Translator voi ylläpitää README-kielten taulukkoa arkistoille, jotka julkaisevat käännettyä sisältöä.
...
Personalisoi sparse-checkout-repositorion URL-osoite käännöksen aikana:
