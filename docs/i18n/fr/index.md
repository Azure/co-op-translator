<section class="home-hero">
  <p class="home-eyebrow">Premiers pas</p>
  <h1>Documentation de Co-op Translator</h1>
  <p class="home-lede">
    Configurez un fournisseur LLM, choisissez vos langues cibles et utilisez Co-op
    Translator depuis la CLI, l'API Python ou le serveur MCP pour traduire et relire
    le contenu du projet au fil des modifications de la source.
  </p>
  <a class="home-link" href="workflows/">Choisissez votre flux de travail -></a>
</section>
...
Ces `docs/` pages are the canonical Co-op Translator documentation. Older setup guides have been consolidated here so CLI, API, MCP, CI, and troubleshooting guidance stay in one place.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Étape 1</span>
    <strong>Configurer votre projet</strong>
    <span>Configurer les fournisseurs, les identifiants, les langues cibles et les répertoires de sortie.</span>
    <em>Lire le guide -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Étape 2</span>
    <strong>Traduire avec la CLI</strong>
    <span>Exécuter des commandes de traduction, d'évaluation, de relecture et de migration de liens.</span>
    <em>Lire le guide -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Étape 3</span>
    <strong>Automatiser avec l'API Python</strong>
    <span>Utiliser Co-op Translator depuis des scripts et des flux d'automatisation.</span>
    <em>Lire le guide -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Étape 4</span>
    <strong>Se connecter au serveur MCP</strong>
    <span>Exposer les outils Co-op Translator aux agents, aux éditeurs et aux clients compatibles MCP.</span>
    <em>Lire le guide -></em>
  </a>
</div>