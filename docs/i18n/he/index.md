<section class="home-hero">
  <p class="home-eyebrow">התחלה</p>
  <h1>תיעוד Co-op Translator</h1>
  <p class="home-lede">
    הגדר ספק LLM, בחר את שפות היעד והשתמש ב‑Co-op
    Translator מתוך ה‑CLI, ה‑Python API, או שרת MCP כדי לתרגם ולסקור
    את תוכן הפרויקט ככל שהמקור משתנה.
  </p>
  <a class="home-link" href="workflows/">בחר את זרימת העבודה שלך -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">שלב 1</span>
    <strong>הגדר את הפרויקט שלך</strong>
    <span>הגדר ספקים, אישורים, שפות יעד ותיקיות פלט.</span>
    <em>קראו את המדריך -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">שלב 2</span>
    <strong>תרגם באמצעות ה‑CLI</strong>
    <span>הפעל פקודות לתרגום, הערכה, סקירה והעברת קישורים.</span>
    <em>קראו את המדריך -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">שלב 3</span>
    <strong>אוטומציה באמצעות ה‑Python API</strong>
    <span>השתמשו ב‑Co-op Translator מתוך סקריפטים וזרימות עבודה אוטומטיות.</span>
    <em>קראו את המדריך -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">שלב 4</span>
    <strong>התחבר לשרת MCP</strong>
    <span>חשוף את כלי Co-op Translator לסוכנים, לעורכים וללקוחות התואמים ל‑MCP.</span>
    <em>קראו את המדריך -></em>
  </a>
</div>