<section class="home-hero">
  <p class="home-eyebrow">शुरू करें</p>
  <h1>Co-op Translator दस्तावेज़</h1>
  <p class="home-lede">
    एक LLM प्रदाता कॉन्फ़िगर करें, अपनी लक्षित भाषाएँ चुनें, और Co-op
    Translator को CLI, Python API, या MCP सर्वर से उपयोग करें ताकि
    स्रोत बदलने पर परियोजना की सामग्री का अनुवाद और समीक्षा कर सकें।
  </p>
  <a class="home-link" href="workflows/">अपना वर्कफ़्लो चुनें -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">चरण 1</span>
    <strong>अपनी परियोजना कॉन्फ़िगर करें</strong>
    <span>प्रदाता, क्रेडेंशियल्स, लक्षित भाषाएँ, और आउटपुट निर्देशिकाएँ सेट करें।</span>
    <em>गाइड पढ़ें -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">चरण 2</span>
    <strong>CLI के साथ अनुवाद करें</strong>
    <span>अनुवाद, मूल्यांकन, समीक्षा, और लिंक माइग्रेशन कमांड चलाएँ।</span>
    <em>गाइड पढ़ें -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">चरण 3</span>
    <strong>Python API के साथ स्वचालन करें</strong>
    <span>स्क्रिप्ट्स और ऑटोमेशन वर्कफ़्लो से Co-op Translator का उपयोग करें।</span>
    <em>गाइड पढ़ें -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">चरण 4</span>
    <strong>MCP सर्वर से कनेक्ट करें</strong>
    <span>एजेंट्स, संपादकों, और MCP-संगत क्लाइंट्स को Co-op Translator के टूल उपलब्ध कराएँ।</span>
    <em>गाइड पढ़ें -></em>
  </a>
</div>