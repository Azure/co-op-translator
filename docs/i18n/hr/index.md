<section class="home-hero">
  <p class="home-eyebrow">Početak rada</p>
  <h1>Dokumentacija Co-op Translatora</h1>
  <p class="home-lede">
    Konfigurirajte davatelja LLM-a, odaberite svoje ciljne jezike i koristite Co-op
    Translator iz CLI-ja, Python API-ja ili MCP servera za prevođenje i pregled
    sadržaja projekta dok se izvor mijenja.
  </p>
  <a class="home-link" href="workflows/">Odaberite svoj tijek rada -></a>
</section>
...
Ove `docs/` stranice su službena dokumentacija Co-op Translatora. Stariji vodiči za postavljanje su ovdje konsolidirani kako bi CLI, API, MCP, CI i smjernice za rješavanje problema ostali na jednom mjestu.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Korak 1</span>
    <strong>Konfigurirajte svoj projekt</strong>
    <span>Postavite davatelje, vjerodajnice, ciljne jezike i izlazne direktorije.</span>
    <em>Pročitajte vodič -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Korak 2</span>
    <strong>Prevođenje pomoću CLI-ja</strong>
    <span>Pokrenite naredbe za prevođenje, evaluaciju, pregled i migraciju poveznica.</span>
    <em>Pročitajte vodič -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Korak 3</span>
    <strong>Automatizirajte pomoću Python API-ja</strong>
    <span>Koristite Co-op Translator iz skripti i automatiziranih tijekova rada.</span>
    <em>Pročitajte vodič -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Korak 4</span>
    <strong>Povežite se s MCP serverom</strong>
    <span>Izložite alate Co-op Translatora agentima, urednicima i MCP-kompatibilnim klijentima.</span>
    <em>Pročitajte vodič -></em>
  </a>
</div>