<section class="home-hero">
  <p class="home-eyebrow">Első lépések</p>
  <h1>Co-op Translator dokumentáció</h1>
  <p class="home-lede">
    Állítson be egy LLM-szolgáltatót, válassza ki a célnyelveket, és használja a Co-op
    Translatort a CLI-ből, a Python API-ból vagy az MCP szerverről a projekt tartalmának fordításához és felülvizsgálatához, ahogy a forrás változik.
  </p>
  <a class="home-link" href="workflows/">Válassza ki a munkafolyamatot -></a>
</section>
...
Ezek a `docs/` oldalak a Co-op Translator kanonikus dokumentációját tartalmazzák. A régebbi telepítési útmutatókat itt egyesítettük, így a CLI-, API-, MCP-, CI- és hibakeresési útmutatások egy helyen találhatók.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">1. lépés</span>
    <strong>Projekt konfigurálása</strong>
    <span>Állítsa be a szolgáltatókat, a hitelesítő adatokat, a célnyelveket és a kimeneti könyvtárakat.</span>
    <em>Olvassa el az útmutatót -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">2. lépés</span>
    <strong>Fordítás a CLI-vel</strong>
    <span>Futtassa a fordítási, értékelési, felülvizsgálati és hivatkozás-migrációs parancsokat.</span>
    <em>Olvassa el az útmutatót -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">3. lépés</span>
    <strong>Automatizálás a Python API-val</strong>
    <span>Használja a Co-op Translatort szkriptekből és automatizált munkafolyamatokból.</span>
    <em>Olvassa el az útmutatót -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">4. lépés</span>
    <strong>Csatlakozás az MCP szerverhez</strong>
    <span>Tegye elérhetővé a Co-op Translator eszközeit ügynökök, szerkesztők és MCP-kompatibilis kliensek számára.</span>
    <em>Olvassa el az útmutatót -></em>
  </a>
</div>