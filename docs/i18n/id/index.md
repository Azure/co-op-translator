<section class="home-hero">
  <p class="home-eyebrow">Memulai</p>
  <h1>Dokumentasi Co-op Translator</h1>
  <p class="home-lede">
    Konfigurasikan penyedia LLM, pilih bahasa target, dan gunakan Co-op
    Translator dari CLI, API Python, atau server MCP untuk menerjemahkan dan meninjau
    konten proyek saat sumber berubah.
  </p>
  <a class="home-link" href="workflows/">Pilih alur kerja -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    ...
    <strong>Konfigurasikan proyek Anda</strong>
    <span>Atur penyedia, kredensial, bahasa target, dan direktori keluaran.</span>
    <em>Baca panduan -></em>
  </a>
  ...
  <a class="quickstart-card" href="cli/">
    ...
    <span>Jalankan perintah terjemahan, evaluasi, peninjauan, dan migrasi tautan.</span>
    <em>Baca panduan -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Langkah 3</span>
    <strong>Otomatiskan dengan API Python</strong>
    <span>Gunakan Co-op Translator dari skrip dan alur kerja otomatisasi.</span>
    <em>Baca panduan -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Langkah 4</span>
    <strong>Hubungkan dengan Server MCP</strong>
    <span>Sediakan alat Co-op Translator untuk agen, editor, dan klien yang kompatibel dengan MCP.</span>
    <em>Baca panduan -></em>
  </a>
</div>