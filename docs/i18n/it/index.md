<section class="home-hero">
  <p class="home-eyebrow">Primi passi</p>
  <h1>Documentazione di Co-op Translator</h1>
  <p class="home-lede">
    Configura un provider LLM, scegli le lingue di destinazione e usa Co-op
    Translator dalla CLI, dall'API Python o dal server MCP per tradurre e revisionare
    i contenuti del progetto mentre la sorgente cambia.
  </p>
  <a class="home-link" href="workflows/">Scegli il flusso di lavoro -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    ...
    <strong>Configura il tuo progetto</strong>
    <span>Imposta provider, credenziali, lingue di destinazione e directory di output.</span>
    <em>Leggi la guida -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Passo 2</span>
    <strong>Traduci con la CLI</strong>
    <span>Esegui comandi di traduzione, valutazione, revisione e migrazione dei link.</span>
    <em>Leggi la guida -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Passo 3</span>
    <strong>Automatizza con l'API Python</strong>
    <span>Usa Co-op Translator da script e flussi di lavoro di automazione.</span>
    <em>Leggi la guida -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Passo 4</span>
    <strong>Connettiti al server MCP</strong>
    <span>Rendi accessibili gli strumenti di Co-op Translator ad agenti, editor e client compatibili con MCP.</span>
    <em>Leggi la guida -></em>
  </a>
</div>