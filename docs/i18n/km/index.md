<section class="home-hero">
  <p class="home-eyebrow">ចាប់ផ្តើម</p>
  <h1>ឯកសារ Co-op Translator</h1>
  <p class="home-lede">
    កំណត់អ្នកផ្គត់ផ្គង់ LLM, ជ្រើសភាសាគោលដៅរបស់អ្នក, ហើយប្រើ Co-op
    Translator ពី CLI, Python API, ឬម៉ាស៊ីនមេ MCP ដើម្បីបកប្រែ និងពិនិត្យមើល
    មាតិកាគម្រោង នៅពេលប្រភពផ្លាស់ប្ដូរ។
  </p>
  <a class="home-link" href="workflows/">ជ្រើសរើសដំណើរការរបស់អ្នក -></a>
</section>
...
ទំព័រ `docs/` ទាំងនេះគឺជា​ឯកសារ​ផ្លូវការសម្រាប់ Co-op Translator។ មគ្គុទេសក៍ចាស់ៗសម្រាប់ការតំឡើងត្រូវបានសម្រួល​ទៅកន្លែង​នេះ ដើម្បីឱ្យណែនាំសម្រាប់ CLI, API, MCP, CI និងការដោះស្រាយបញ្ហា មាននៅកន្លែងតែមួយ។ 

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">ជំហានទី 1</span>
    <strong>កំណត់រចនាសម្ព័ន្ធគម្រោងរបស់អ្នក</strong>
    <span>កំណត់អ្នកផ្គត់ផ្គង់, ព័ត៌មានសម្គាល់ចូល (credentials), ភាសាគោលដៅ និងថតចេញ។</span>
    <em>អានមគ្គុទេសក៍ -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">ជំហានទី 2</span>
    <strong>បកប្រែដោយ CLI</strong>
    <span>រត់ពាក្យបញ្ជាសម្រាប់បកប្រែ, ការវាយតម្លៃ, ការពិនិត្យ, និងការផ្លាស់ទីតំណភ្ជាប់។</span>
    <em>អានមគ្គុទេសក៍ -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">ជំហានទី 3</span>
    <strong>ធ្វើអូតូម៉ាទិចដោយ Python API</strong>
    <span>ប្រើ Co-op Translator ពីស្គ្រីប និងដំណើរការ​អូតូម៉ាទិច។</span>
    <em>អានមគ្គុទេសក៍ -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">ជំហានទី 4</span>
    <strong>ភ្ជាប់ទៅម៉ាស៊ីនមេ MCP</strong>
    <span>បង្ហាញឧបករណ៍ Co-op Translator ទៅភ្នាក់ងារ, អ្នកកែសម្រួល, និងកម្មវិធីអតិថិជនដែលត្រូវនឹង MCP។</span>
    <em>អានមគ្គុទេសក៍ -></em>
  </a>
</div>