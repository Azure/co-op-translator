<section class="home-hero">
  <p class="home-eyebrow">Pradžia</p>
  <h1>Co-op Translator dokumentacija</h1>
  <p class="home-lede">
    Konfigūruokite LLM tiekėją, pasirinkite tikslines kalbas ir naudokite Co-op
    Translator per CLI, Python API arba MCP serverį, kad verstumėte ir peržiūrėtumėte
    projekto turinį, kai keičiasi šaltinis.
  </p>
  <a class="home-link" href="workflows/">Pasirinkite darbo eigą -></a>
</section>
...
Šios `docs/` puslapiai yra oficiali Co-op Translator dokumentacija. Senesni diegimo vadovai buvo sujungti čia, kad CLI, API, MCP, CI ir trikčių šalinimo gairės būtų vienoje vietoje.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">1 žingsnis</span>
    <strong>Konfigūruokite projektą</strong>
    <span>Nustatykite tiekėjus, kredencialus, tikslines kalbas ir išvesties katalogus.</span>
    <em>Skaitykite vadovą -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">2 žingsnis</span>
    <strong>Versti naudojant CLI</strong>
    <span>Vykdykite vertimo, vertinimo, peržiūros ir nuorodų migracijos komandas.</span>
    <em>Skaitykite vadovą -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">3 žingsnis</span>
    <strong>Automatizuokite naudodami Python API</strong>
    <span>Naudokite Co-op Translator iš skriptų ir automatizavimo darbo eigų.</span>
    <em>Skaitykite vadovą -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">4 žingsnis</span>
    <strong>Prisijunkite prie MCP serverio</strong>
    <span>Padarykite Co-op Translator įrankius prieinamus agentams, redaktoriams ir MCP suderinamiems klientams.</span>
    <em>Skaitykite vadovą -></em>
  </a>
</div>