<section class="home-hero">
  <p class="home-eyebrow">सुरूवात</p>
  <h1>Co-op Translator दस्तऐवजीकरण</h1>
  <p class="home-lede">
    एक LLM प्रदाता कॉन्फिगर करा, आपल्या लक्ष्य भाषा निवडा, आणि Co-op
    Translator ला CLI, Python API, किंवा MCP सर्व्हरमधून वापरून
    स्रोत बदलल्यावर प्रकल्पातील सामग्रीचे भाषांतर आणि पुनरावलोकन करा.
  </p>
  <a class="home-link" href="workflows/">आपले कार्यप्रवाह निवडा -></a>
</section>
...
हे `docs/` पृष्ठे Co-op Translator चे अधिकृत दस्तऐवजीकरण आहेत. जुनी सेटअप मार्गदर्शिका येथे एकत्र केलेली आहेत जेणेकरून CLI, API, MCP, CI, आणि समस्या निवारण मार्गदर्शन एका ठिकाणी राहील.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">पायरी 1</span>
    <strong>आपला प्रकल्प कॉन्फिगर करा</strong>
    <span>प्रदाता, प्रमाणपत्रे, लक्ष्य भाषा आणि आउटपुट निर्देशिका सेट करा.</span>
    <em>मार्गदर्शक वाचा -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">पायरी 2</span>
    <strong>CLI वापरून भाषांतर करा</strong>
    <span>भाषांतर, मूल्यांकन, पुनरावलोकन आणि दुवा स्थलांतर आदेश चालवा.</span>
    <em>मार्गदर्शक वाचा -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">पायरी 3</span>
    <strong>Python API वापरून स्वयंचलित करा</strong>
    <span>स्क्रिप्ट्स आणि ऑटोमेशन वर्कफ्लो मधून Co-op Translator वापरा.</span>
    <em>मार्गदर्शक वाचा -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">पायरी 4</span>
    <strong>MCP सर्व्हरशी कनेक्ट करा</strong>
    <span>एजंट्स, संपादक, आणि MCP-सुसंगत क्लायंट्सना Co-op Translator चे साधने उपलब्ध करा.</span>
    <em>मार्गदर्शक वाचा -></em>
  </a>
</div>