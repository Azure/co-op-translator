...
Co-op Translator menyokong kod bahasa berikut untuk output terjemahan teks, buku nota, dan imej.

Jika anda ingin menambah bahasa baru, kemas kini pemetaan bahasa dan fon di bawah `src/co_op_translator/fonts/` dan uji bahasa tersebut sebelum membuka pull request.
...
Untuk menambah sokongan bagi bahasa baru:

1. Tambahkan kod bahasa dan nama paparan kepada utiliti bahasa.
2. Tambah atau peta fon dalam `src/co_op_translator/fonts/font_language_mappings.yml`.
3. Uji output terjemahan Markdown dan imej.
