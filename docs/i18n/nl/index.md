<section class="home-hero">
  <p class="home-eyebrow">Aan de slag</p>
  <h1>Co-op Translator-documentatie</h1>
  <p class="home-lede">
    Configureer een LLM-provider, kies uw doeltalen en gebruik Co-op
    Translator via de CLI, Python API of MCP-server om projectinhoud te vertalen en te beoordelen
    terwijl de bron verandert.
  </p>
  <a class="home-link" href="workflows/">Kies uw workflow -></a>
</section>
...
Deze `docs/`-pagina's vormen de canonieke Co-op Translator-documentatie. Oudere installatiehandleidingen zijn hier samengevoegd zodat CLI-, API-, MCP-, CI- en probleemoplossingsrichtlijnen op één plek blijven.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Stap 1</span>
    <strong>Configureer uw project</strong>
    <span>Stel providers, referenties, doeltalen en uitvoermappen in.</span>
    <em>Lees de handleiding -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Stap 2</span>
    <strong>Vertalen via de CLI</strong>
    <span>Voer opdrachten uit voor vertaling, evaluatie, review en linkmigratie.</span>
    <em>Lees de handleiding -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Stap 3</span>
    <strong>Automatiseer met de Python-API</strong>
    <span>Gebruik Co-op Translator vanuit scripts en automatiseringsworkflows.</span>
    <em>Lees de handleiding -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Stap 4</span>
    <strong>Maak verbinding met de MCP-server</strong>
    <span>Maak Co-op Translator-tools beschikbaar voor agenten, redacteuren en MCP-compatibele clients.</span>
    <em>Lees de handleiding -></em>
  </a>
</div>