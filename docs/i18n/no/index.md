<section class="home-hero">
  <p class="home-eyebrow">Kom i gang</p>
  <h1>Co-op Translator-dokumentasjon</h1>
  <p class="home-lede">
    Konfigurer en LLM-leverandør, velg målspråk, og bruk Co-op
    Translator fra CLI, Python-APIet, eller MCP-serveren for å oversette og gjennomgå
    prosjektinnhold etter hvert som kilden endres.
  </p>
  <a class="home-link" href="workflows/">Velg arbeidsflyt -></a>
</section>
...
Disse `docs/`-sidene er den kanoniske Co-op Translator-dokumentasjonen. Eldre oppsettsguider er konsolidert her slik at veiledning for CLI, API, MCP, CI, og feilsøking samles på ett sted.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Trinn 1</span>
    <strong>Konfigurer prosjektet ditt</strong>
    <span>Sett opp leverandører, legitimasjon, målspråk og utdata-mapper.</span>
    <em>Les veiledningen -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Trinn 2</span>
    <strong>Oversett med CLI</strong>
    <span>Kjør kommandoer for oversettelse, evaluering, gjennomgang og lenkemigrering.</span>
    <em>Les veiledningen -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Trinn 3</span>
    <strong>Automatiser med Python-APIet</strong>
    <span>Bruk Co-op Translator fra skript og automatiseringsarbeidsflyter.</span>
    <em>Les veiledningen -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Trinn 4</span>
    <strong>Koble til MCP-serveren</strong>
    <span>Eksponer Co-op Translator-verktøy for agenter, redaktører og MCP-kompatible klienter.</span>
    <em>Les veiledningen -></em>
  </a>
</div>