<section class="home-hero">
  <p class="home-eyebrow">Pierwsze kroki</p>
  <h1>Dokumentacja Co-op Translator</h1>
  <p class="home-lede">
    Skonfiguruj dostawcę LLM, wybierz docelowe języki i korzystaj z Co-op
    Translator z poziomu CLI, Python API lub serwera MCP, aby tłumaczyć i przeglądać
    zawartość projektu w miarę zmian w źródle.
  </p>
  <a class="home-link" href="workflows/">Wybierz swój przepływ pracy -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    ...
    <span>Skonfiguruj dostawców, poświadczenia, docelowe języki i katalogi wyjściowe.</span>
    <em>Przeczytaj przewodnik -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Krok 2</span>
    <strong>Tłumacz za pomocą CLI</strong>
    <span>Uruchom polecenia tłumaczenia, oceny, przeglądu i migracji linków.</span>
    <em>Przeczytaj przewodnik -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Krok 3</span>
    <strong>Automatyzuj za pomocą Python API</strong>
    <span>Używaj Co-op Translator w skryptach i automatycznych przepływach pracy.</span>
    <em>Przeczytaj przewodnik -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Krok 4</span>
    <strong>Połącz z serwerem MCP</strong>
    <span>Udostępnij narzędzia Co-op Translator agentom, redaktorom i klientom zgodnym z MCP.</span>
    <em>Przeczytaj przewodnik -></em>
  </a>
</div>