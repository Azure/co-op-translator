<section class="home-hero">
  <p class="home-eyebrow">Primeiros passos</p>
  <h1>Documentação do Co-op Translator</h1>
  <p class="home-lede">
    Configure um provedor de LLM, escolha seus idiomas de destino e use o Co-op
    Translator pela CLI, API Python ou servidor MCP para traduzir e revisar
    o conteúdo do projeto conforme a origem muda.
  </p>
  <a class="home-link" href="workflows/">Escolha seu fluxo de trabalho -></a>
</section>
...
Estas `docs/` páginas são a documentação canônica do Co-op Translator. Guias de configuração antigos foram consolidados aqui para que as orientações de CLI, API, MCP, CI e solução de problemas fiquem em um só lugar.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Passo 1</span>
    <strong>Configure seu projeto</strong>
    <span>Configure provedores, credenciais, idiomas de destino e diretórios de saída.</span>
    <em>Leia o guia -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Passo 2</span>
    <strong>Traduza com a CLI</strong>
    <span>Execute comandos de tradução, avaliação, revisão e migração de links.</span>
    <em>Leia o guia -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Passo 3</span>
    <strong>Automatize com a API Python</strong>
    <span>Use o Co-op Translator em scripts e fluxos de trabalho de automação.</span>
    <em>Leia o guia -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Passo 4</span>
    <strong>Conecte-se ao servidor MCP</strong>
    <span>Exponha as ferramentas do Co-op Translator para agentes, editores e clientes compatíveis com MCP.</span>
    <em>Leia o guia -></em>
  </a>
</div>