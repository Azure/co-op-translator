...
Se estiver a decidir entre CLI, API Python e MCP, comece com [Escolha o seu fluxo de trabalho](workflows.md).

## Fluxo inicial da CLI

Comece aqui se estiver a usar o Co-op Translator a partir de um terminal:

1. Configure um fornecedor de LLM conforme descrito em [Configuration](configuration.md).
