<section class="home-hero">
  ...
  <p class="home-lede">
    Configure um fornecedor de LLM, escolha as suas línguas de destino e utilize o Co-op
    Translator a partir da CLI, da API Python ou do servidor MCP para traduzir e rever
    o conteúdo do projeto à medida que a origem muda.
  </p>
  <a class="home-link" href="workflows/">Escolha o seu fluxo de trabalho -></a>
</section>
...
Estas `docs/` pages are the canonical Co-op Translator documentation. Older setup guides have been consolidated here so CLI, API, MCP, CI, and troubleshooting guidance stay in one place.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Passo 1</span>
    <strong>Configure o seu projeto</strong>
    <span>Configure fornecedores, credenciais, línguas de destino e diretórios de saída.</span>
    <em>Ler o guia -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Passo 2</span>
    <strong>Traduzir com CLI</strong>
  ...
  <a class="quickstart-card" href="mcp/">
    ...
    <strong>Ligue ao servidor MCP</strong>
    <span>Disponibilize as ferramentas do Co-op Translator a agentes, editores e clientes compatíveis com MCP.</span>
    <em>Ler o guia -></em>
  </a>
</div>