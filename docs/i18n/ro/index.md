<section class="home-hero">
  <p class="home-eyebrow">Începeți</p>
  <h1>Documentația Co-op Translator</h1>
  <p class="home-lede">
    Configurați un furnizor LLM, alegeți limbile țintă și folosiți Co-op
    Translator din CLI, API-ul Python sau serverul MCP pentru a traduce și a revizui
    conținutul proiectului pe măsură ce sursa se schimbă.
  </p>
  <a class="home-link" href="workflows/">Alegeți fluxul de lucru -></a>
</section>
...
Aceste pagini `docs/` sunt documentația canonică pentru Co-op Translator. Ghidurile mai vechi de configurare au fost consolidate aici astfel încât instrucțiunile pentru CLI, API, MCP, CI și depanare să rămână într-un singur loc.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Pasul 1</span>
    <strong>Configurați proiectul</strong>
    <span>Configurați furnizorii, acreditările, limbile țintă și directoarele de ieșire.</span>
    <em>Citiți ghidul -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Pasul 2</span>
    <strong>Traduceți cu CLI</strong>
    <span>Rulați comenzi de traducere, evaluare, revizuire și migrare a linkurilor.</span>
    <em>Citiți ghidul -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Pasul 3</span>
    <strong>Automatizați cu API-ul Python</strong>
    <span>Folosiți Co-op Translator din scripturi și fluxuri de lucru automatizate.</span>
    <em>Citiți ghidul -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Pasul 4</span>
    <strong>Conectați-vă la serverul MCP</strong>
    <span>Expuneți instrumentele Co-op Translator agenților, editorilor și clienților compatibili MCP.</span>
    <em>Citiți ghidul -></em>
  </a>
</div>