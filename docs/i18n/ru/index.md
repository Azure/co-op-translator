<section class="home-hero">
  <p class="home-eyebrow">Начало работы</p>
  <h1>Документация Co-op Translator</h1>
  <p class="home-lede">
    Настройте провайдера LLM, выберите целевые языки и используйте Co-op Translator через CLI, Python API или сервер MCP для перевода и проверки содержимого проекта по мере изменения источника.
  </p>
  <a class="home-link" href="workflows/">Выберите рабочий процесс -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Шаг 1</span>
    <strong>Настройте проект</strong>
    <span>Настройте провайдеров, учетные данные, целевые языки и каталоги вывода.</span>
    <em>Читать руководство -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Шаг 2</span>
    <strong>Перевод с помощью CLI</strong>
    <span>Выполняйте команды перевода, оценки, проверки и миграции ссылок.</span>
    <em>Читать руководство -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Шаг 3</span>
    <strong>Автоматизируйте с помощью Python API</strong>
    <span>Используйте Co-op Translator в скриптах и автоматизированных рабочих процессах.</span>
    <em>Читать руководство -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Шаг 4</span>
    <strong>Подключение к серверу MCP</strong>
    <span>Предоставьте инструменты Co-op Translator агентам, редакторам и клиентам, совместимым с MCP.</span>
    <em>Читать руководство -></em>
  </a>
</div>