<section class="home-hero">
  <p class="home-eyebrow">Začíname</p>
  <h1>Dokumentácia Co-op Translator</h1>
  <p class="home-lede">
    Nakonfigurujte poskytovateľa LLM, vyberte cieľové jazyky a používajte Co-op
    Translator z CLI, Python API alebo MCP servera na preklad a kontrolu
    obsahu projektu pri zmene zdroja.
  </p>
  <a class="home-link" href="workflows/">Vyberte svoj pracovný tok -></a>
</section>
...
Tieto `docs/` stránky sú kanonickou dokumentáciou Co-op Translator. Staršie inštrukcie na nastavenie boli tu zjednotené, takže pokyny pre CLI, API, MCP, CI a riešenie problémov sú na jednom mieste.

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Krok 1</span>
    <strong>Nakonfigurujte svoj projekt</strong>
    <span>Nastavte poskytovateľov, prihlasovacie údaje, cieľové jazyky a výstupné adresáre.</span>
    <em>Prečítajte si príručku -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Krok 2</span>
    <strong>Prekladajte cez CLI</strong>
    <span>Spúšťajte príkazy na preklad, vyhodnotenie, kontrolu a migráciu odkazov.</span>
    <em>Prečítajte si príručku -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Krok 3</span>
    <strong>Automatizujte pomocou Python API</strong>
    <span>Používajte Co-op Translator v skriptoch a automatizačných pracovných tokoch.</span>
    <em>Prečítajte si príručku -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Krok 4</span>
    <strong>Pripojte sa k MCP serveru</strong>
    <span>Sprístupnite nástroje Co-op Translator agentom, editorom a klientom kompatibilným s MCP.</span>
    <em>Prečítajte si príručku -></em>
  </a>
</div>