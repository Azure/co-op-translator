<section class="home-hero">
  <p class="home-eyebrow">Začetek</p>
  <h1>Dokumentacija Co-op Translatorja</h1>
  <p class="home-lede">
    Konfigurirajte ponudnika LLM, izberite ciljne jezike in uporabljajte Co-op
    Translator prek CLI, Python API ali MCP strežnika za prevajanje in pregledovanje
    vsebine projekta, ko se izvor spremeni.
  </p>
  <a class="home-link" href="workflows/">Izberite svoj potek dela -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    ...
    <span>Nastavite ponudnike, prijavne podatke, ciljne jezike in izhodne mape.</span>
    <em>Preberite vodič -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Korak 2</span>
    <strong>Prevajajte z CLI</strong>
    <span>Zaženite ukaze za prevajanje, ocenjevanje, pregledovanje in migracijo povezav.</span>
    <em>Preberite vodič -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Korak 3</span>
    <strong>Avtomatizirajte s Python API-jem</strong>
    <span>Uporabite Co-op Translator iz skript in avtomatiziranih delovnih tokov.</span>
    <em>Preberite vodič -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Korak 4</span>
    <strong>Povežite se s strežnikom MCP</strong>
    <span>Omogočite orodja Co-op Translator agentom, urednikom in odjemalcem, združljivim z MCP.</span>
    <em>Preberite vodič -></em>
  </a>
</div>