...
See [Конфигурација](configuration.md) and [Подешавање Azure AI](azure-ai-setup.md) for local configuration details.
...
![Одаберите тајне за Actions](../../assets/github-actions/select-setting-action.png)
...
![Подешавање дозвола за workflow](../../assets/github-actions/permission-setting.png)
...
`co-op-review` је бета детерминистичка команда за преглед. Њене провере и шема излаза могу се мењати, али је дизајнирана да буде безбедна за CI јер не уписује фајлове нити позива провајдере модела.