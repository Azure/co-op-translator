<section class="home-hero">
  <p class="home-eyebrow">Почетак</p>
  <h1>Документација Co-op Translator-а</h1>
  <p class="home-lede">
    Конфигуришите провајдера LLM-а, изаберите циљне језике и користите Co-op
    Translator из CLI-ја, Python API-ја или MCP сервера да бисте преводили и прегледали
    пројектни садржај како се изворни садржај мења.
  </p>
  <a class="home-link" href="workflows/">Одаберите ваш радни ток -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Корак 1</span>
    <strong>Подесите ваш пројекат</strong>
    <span>Поставите провајдере, акредитиве, циљне језике и излазне директоријуме.</span>
    <em>Прочитајте упутство -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Корак 2</span>
    <strong>Преводите помоћу CLI-ја</strong>
    <span>Извршавајте команде за превођење, евалуацију, преглед и миграцију линкова.</span>
    <em>Прочитајте упутство -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Корак 3</span>
    <strong>Аутоматизујте помоћу Python API-ја</strong>
    <span>Користите Co-op Translator из скрипти и аутоматизационих радних токова.</span>
    <em>Прочитајте упутство -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Корак 4</span>
    <strong>Повежите се са MCP сервером</strong>
    <span>Учните алате Co-op Translator доступним агентима, уредницима и MCP-компатибилним клијентима.</span>
    <em>Прочитајте упутство -></em>
  </a>
</div>