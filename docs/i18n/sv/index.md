<section class="home-hero">
  <p class="home-eyebrow">Kom igång</p>
  <h1>Co-op Translator-dokumentation</h1>
  <p class="home-lede">
    Konfigurera en LLM-leverantör, välj dina målspråk och använd Co-op
    Translator från CLI, Python-API eller MCP-servern för att översätta och granska
    projektinnehåll när källan ändras.
  </p>
  <a class="home-link" href="workflows/">Välj ditt arbetsflöde -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Steg 1</span>
    <strong>Konfigurera ditt projekt</strong>
    <span>Ställ in leverantörer, autentiseringsuppgifter, målspråk och utmatningskataloger.</span>
    <em>Läs guiden -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Steg 2</span>
    <strong>Översätt med CLI</strong>
    <span>Kör kommandon för översättning, utvärdering, granskning och länkmigrering.</span>
    <em>Läs guiden -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Steg 3</span>
    <strong>Automatisera med Python-API</strong>
    <span>Använd Co-op Translator från skript och automatiseringsarbetsflöden.</span>
    <em>Läs guiden -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Steg 4</span>
    <strong>Anslut till MCP-servern</strong>
    <span>Exponera Co-op Translator-verktyg för agenter, redaktörer och MCP-kompatibla klienter.</span>
    <em>Läs guiden -></em>
  </a>
</div>