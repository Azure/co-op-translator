<section class="home-hero">
  <p class="home-eyebrow">Kuanzia</p>
  <h1>Nyaraka za Co-op Translator</h1>
  <p class="home-lede">
    Sanidi mtoa huduma wa LLM, chagua lugha unazolenga, na tumia Co-op
    Translator kutoka CLI, Python API, au seva ya MCP kutafsiri na kukagua
    yaliyomo ya mradi wakati chanzo kinapobadilika.
  </p>
  <a class="home-link" href="workflows/">Chagua mtiririko wako wa kazi -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Hatua 1</span>
    <strong>Sanidi mradi wako</strong>
    <span>Sanidi watoaji, vyeti vya kuthibitisha (credentials), lugha unazolenga, na saraka za pato.</span>
    <em>Soma mwongozo -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Hatua 2</span>
    <strong>Tafsiri kwa kutumia CLI</strong>
    <span>Endesha amri za kutafsiri, kutathmini, kukagua, na uhamisho wa viungo.</span>
    <em>Soma mwongozo -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Hatua 3</span>
    <strong>Otomatisha kwa kutumia Python API</strong>
    <span>Tumia Co-op Translator kutoka kwenye skiripti na mitiririko ya otomatiki.</span>
    <em>Soma mwongozo -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Hatua 4</span>
    <strong>Unganisha na seva ya MCP</strong>
    <span>Fungua zana za Co-op Translator kwa maajenti, wahariri, na wateja wanaoendana na MCP.</span>
    <em>Soma mwongozo -></em>
  </a>
</div>