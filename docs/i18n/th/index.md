<section class="home-hero">
  <p class="home-eyebrow">เริ่มต้น</p>
  <h1>เอกสาร Co-op Translator</h1>
  <p class="home-lede">
    กำหนดค่าผู้ให้บริการ LLM, เลือกภาษาที่เป็นเป้าหมาย และใช้ Co-op
    Translator จาก CLI, Python API, หรือเซิร์ฟเวอร์ MCP เพื่อแปลและตรวจทาน
    เนื้อหาโครงการขณะที่ต้นฉบับเปลี่ยนแปลง
  </p>
  <a class="home-link" href="workflows/">เลือกเวิร์กโฟลว์ของคุณ -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">ขั้นตอนที่ 1</span>
    <strong>กำหนดค่าโปรเจกต์ของคุณ</strong>
    <span>ตั้งค่าผู้ให้บริการ, ข้อมูลรับรอง, ภาษาที่เป็นเป้าหมาย, และไดเรกทอรีผลลัพธ์.</span>
    <em>อ่านคำแนะนำ -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">ขั้นตอนที่ 2</span>
    <strong>แปลด้วย CLI</strong>
    <span>เรียกใช้คำสั่งแปล, ประเมินผล, ตรวจทาน, และย้ายลิงก์.</span>
    <em>อ่านคำแนะนำ -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">ขั้นตอนที่ 3</span>
    <strong>ทำให้อัตโนมัติด้วย Python API</strong>
    <span>ใช้ Co-op Translator จากสคริปต์และเวิร์กโฟลว์อัตโนมัติ.</span>
    <em>อ่านคำแนะนำ -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">ขั้นตอนที่ 4</span>
    <strong>เชื่อมต่อกับเซิร์ฟเวอร์ MCP</strong>
    <span>เผยแพร่เครื่องมือ Co-op Translator ให้กับเอเจนต์, ผู้แก้ไข, และไคลเอนต์ที่รองรับ MCP.</span>
    <em>อ่านคำแนะนำ -></em>
  </a>
</div>