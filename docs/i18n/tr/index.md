<section class="home-hero">
  <p class="home-eyebrow">Başlarken</p>
  <h1>Co-op Translator Belgeleri</h1>
  <p class="home-lede">
    Bir LLM sağlayıcısı yapılandırın, hedef dilleri seçin ve kaynak değiştikçe proje içeriğini çevirmek ve gözden geçirmek için Co-op Translator'ı CLI, Python API veya MCP sunucusundan kullanın.
  </p>
  <a class="home-link" href="workflows/">İş akışınızı seçin -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Adım 1</span>
    <strong>Projenizi yapılandırın</strong>
    <span>Sağlayıcıları, kimlik bilgilerini, hedef dilleri ve çıktı dizinlerini ayarlayın.</span>
    <em>Kılavuzu okuyun -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Adım 2</span>
    <strong>CLI ile çeviri yapın</strong>
    <span>Çeviri, değerlendirme, inceleme ve bağlantı taşıma komutlarını çalıştırın.</span>
    <em>Kılavuzu okuyun -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Adım 3</span>
    <strong>Python API ile otomatikleştirin</strong>
    <span>Betiklerden ve otomasyon iş akışlarından Co-op Translator'ı kullanın.</span>
    <em>Kılavuzu okuyun -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Adım 4</span>
    <strong>MCP Sunucusuna bağlanın</strong>
    <span>Co-op Translator araçlarını ajanlara, editörlere ve MCP uyumlu istemcilere sunun.</span>
    <em>Kılavuzu okuyun -></em>
  </a>
</div>