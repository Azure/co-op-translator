<section class="home-hero">
  <p class="home-eyebrow">Початок роботи</p>
  <h1>Документація Co-op Translator</h1>
  <p class="home-lede">
    Налаштуйте провайдера LLM, оберіть цільові мови, та використовуйте Co-op
    Translator через CLI, Python API або сервер MCP для перекладу й перегляду
    вмісту проєкту під час зміни джерела.
  </p>
  <a class="home-link" href="workflows/">Виберіть свій робочий процес -></a>
</section>
...
<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">Крок 1</span>
    <strong>Налаштуйте свій проєкт</strong>
    <span>Налаштуйте провайдерів, облікові дані, цільові мови, та каталоги виводу.</span>
    <em>Прочитати посібник -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">Крок 2</span>
    <strong>Перекладайте за допомогою CLI</strong>
    <span>Запускайте команди для перекладу, оцінки, перегляду та міграції посилань.</span>
    <em>Прочитати посібник -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">Крок 3</span>
    <strong>Автоматизуйте за допомогою Python API</strong>
    <span>Використовуйте Co-op Translator у скриптах та автоматизованих робочих процесах.</span>
    <em>Прочитати посібник -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">Крок 4</span>
    <strong>Підключіться до сервера MCP</strong>
    <span>Зробіть інструменти Co-op Translator доступними для агентів, редакторів та клієнтів, сумісних з MCP.</span>
    <em>Прочитати посібник -></em>
  </a>
</div>