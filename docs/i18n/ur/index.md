<section class="home-hero">
  <p class="home-eyebrow">شروع کریں</p>
  <h1>Co-op Translator کی دستاویزات</h1>
  <p class="home-lede">
    ایک LLM فراہم کنندہ ترتیب دیں، اپنی ہدف زبانیں منتخب کریں، اور Co-op
    Translator کو CLI، Python API، یا MCP سرور سے استعمال کریں تاکہ پروجیکٹ کے مواد کا ترجمہ اور جائزہ لیا جا سکے
    جب ماخذ تبدیل ہوتا ہے۔
  </p>
  <a class="home-link" href="workflows/">اپنا ورک فلو منتخب کریں -></a>
</section>
...
یہ `docs/` صفحات Co-op Translator کی مستند دستاویزات ہیں۔ پرانے سیٹ اپ گائیڈز کو یہاں یکجا کیا گیا ہے تاکہ CLI، API، MCP، CI، اور مسئلے حل کرنے کی رہنمائی ایک جگہ پر موجود رہے۔

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">مرحلہ 1</span>
    <strong>اپنے پروجیکٹ کو ترتیب دیں</strong>
    <span>پرووائیڈرز، اسناد، ہدف زبانیں، اور آؤٹ پٹ ڈائریکٹریز سیٹ کریں۔</span>
    <em>گائیڈ پڑھیں -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">مرحلہ 2</span>
    <strong>CLI کے ذریعے ترجمہ کریں</strong>
    <span>ترجمہ، تشخیص، جائزہ، اور لنک مائیگریشن کمانڈز چلائیں۔</span>
    <em>گائیڈ پڑھیں -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">مرحلہ 3</span>
    <strong>Python API کے ذریعے خودکار کریں</strong>
    <span>اسکرپٹس اور آٹومیشن ورک فلو سے Co-op Translator استعمال کریں۔</span>
    <em>گائیڈ پڑھیں -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">مرحلہ 4</span>
    <strong>MCP سرور سے منسلک کریں</strong>
    <span>Co-op Translator کے ٹولز کو ایجنٹس، ایڈیٹرز، اور MCP-مطابقت رکھنے والے کلائنٹس کے لیے دستیاب کریں۔</span>
    <em>گائیڈ پڑھیں -></em>
  </a>
</div>