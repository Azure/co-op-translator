<section class="home-hero">
  <p class="home-eyebrow">入门</p>
  <h1>Co-op Translator 文档</h1>
  <p class="home-lede">
    配置 LLM 提供者，选择目标语言，并通过 CLI、Python API 或 MCP 服务器使用 Co-op Translator，在源内容更改时对项目内容进行翻译和审核。
  </p>
  <a class="home-link" href="workflows/">选择工作流程 -></a>
</section>
...
这些 `docs/` 页面是 Co-op Translator 的权威文档。较旧的设置指南已在此合并，以便 CLI、API、MCP、CI 和故障排除指南集中在一个位置。

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">第 1 步</span>
    <strong>配置你的项目</strong>
    <span>设置提供者、凭据、目标语言和输出目录。</span>
    <em>阅读指南 -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">第 2 步</span>
    <strong>使用 CLI 翻译</strong>
    <span>运行翻译、评估、审核和链接迁移命令。</span>
    <em>阅读指南 -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">第 3 步</span>
    <strong>使用 Python API 自动化</strong>
    <span>在脚本和自动化工作流中使用 Co-op Translator。</span>
    <em>阅读指南 -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">第 4 步</span>
    <strong>与 MCP 服务器连接</strong>
    <span>向代理、编辑器和与 MCP 兼容的客户端公开 Co-op Translator 工具。</span>
    <em>阅读指南 -></em>
  </a>
</div>