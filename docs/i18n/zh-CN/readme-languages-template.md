...
Co-op Translator 可以为发布翻译内容的仓库维护 README 语言表。

当你希望 Co-op Translator 在每次翻译运行时替换整段内容时，请使用下面的标记。如果你希望手动维护自定义子集，请删除这些标记。
...
在翻译过程中个性化 sparse-checkout 仓库 URL:

```bash
translate -l "ko" --repo-url "https://github.com/org/repo.git"
```

如果这些标记存在，Co-op Translator 可以在添加或更改语言时更新生成的表格。