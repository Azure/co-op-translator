<section class="home-hero">
  ...
  <p class="home-lede">
    設定 LLM 提供者、選擇目標語言，並使用 Co-op
    Translator 從 CLI、Python API 或 MCP 伺服器使用，以翻譯並審閱
    專案內容，當原文變更時。
  </p>
...
這些 `docs/` 頁面為 Co-op Translator 的正式文件。較舊的設定指南已合併在此，以便 CLI、API、MCP、CI，與疑難排解指引集中在同一處。

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">步驟 1</span>
    <strong>設定你的專案</strong>
    <span>設定提供者、憑證、目標語言，及輸出目錄。</span>
    <em>閱讀指南 -></em>
  </a>
  ...
  <a class="quickstart-card" href="mcp/">
    ...
    <span>將 Co-op Translator 工具暴露給代理、編輯者，以及與 MCP 相容的用戶端。</span>
    <em>閱讀指南 -></em>
  </a>
</div>