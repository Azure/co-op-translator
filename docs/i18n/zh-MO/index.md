<section class="home-hero">
  <p class="home-eyebrow">開始使用</p>
  <h1>Co-op Translator 文件</h1>
  <p class="home-lede">
    設定 LLM 提供者、選擇目標語言，並從 CLI、Python API 或 MCP 伺服器使用 Co-op Translator，以在原始內容變更時翻譯和審查專案內容。
  </p>
  <a class="home-link" href="workflows/">選擇您的工作流程 -></a>
</section>
...
這些 `docs/` 頁面是 Co-op Translator 的權威文件。舊的設定指南已在此整合，以便 CLI、API、MCP、CI 和疑難排解指南集中在同一處。

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">步驟 1</span>
    <strong>設定您的專案</strong>
    <span>設定提供者、憑證、目標語言及輸出目錄。</span>
    <em>閱讀指南 -></em>
  </a>
  ...
  <a class="quickstart-card" href="api/">
    ...
    <span>在腳本和自動化工作流程中使用 Co-op Translator。</span>
    <em>閱讀指南 -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">步驟 4</span>
    <strong>與 MCP 伺服器連接</strong>
    <span>向代理人、編輯者以及相容 MCP 的用戶端公開 Co-op Translator 工具。</span>
    <em>閱讀指南 -></em>
  </a>
</div>