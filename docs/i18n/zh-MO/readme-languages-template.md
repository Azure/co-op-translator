...
Co-op Translator 可以為發佈已翻譯內容的儲存庫維護 README 的語言表格。

當您希望 Co-op Translator 在每次翻譯執行時取代整個區段時，請使用下方的標記。如果您希望手動維護自訂子集，請移除這些標記。
...
如果這些標記存在，Co-op Translator 可以在新增或變更語言時更新所產生的表格。