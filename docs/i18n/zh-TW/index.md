<section class="home-hero">
  <p class="home-eyebrow">快速開始</p>
  <h1>Co-op Translator 文件</h1>
  <p class="home-lede">
    配置 LLM 提供者、選擇目標語言，並透過 CLI、Python API 或 MCP 伺服器使用 Co-op Translator，在原始內容變更時翻譯並審閱專案內容。
  </p>
  <a class="home-link" href="workflows/">選擇你的工作流程 -></a>
</section>
...
這些 `docs/` 頁面是 Co-op Translator 的權威文件。舊的設定指南已在此整合，因此 CLI、API、MCP、CI 與疑難排解說明可集中於同一處。

<div class="quickstart-grid">
  <a class="quickstart-card" href="configuration/">
    <span class="quickstart-step">步驟 1</span>
    <strong>設定您的專案</strong>
    <span>設定提供者、憑證、目標語言、與輸出目錄。</span>
    <em>閱讀指南 -></em>
  </a>

  <a class="quickstart-card" href="cli/">
    <span class="quickstart-step">步驟 2</span>
    <strong>使用 CLI 翻譯</strong>
    <span>執行翻譯、評估、審閱與連結遷移命令。</span>
    <em>閱讀指南 -></em>
  </a>

  <a class="quickstart-card" href="api/">
    <span class="quickstart-step">步驟 3</span>
    <strong>使用 Python API 自動化</strong>
    <span>在腳本與自動化工作流程中使用 Co-op Translator。</span>
    <em>閱讀指南 -></em>
  </a>

  <a class="quickstart-card" href="mcp/">
    <span class="quickstart-step">步驟 4</span>
    <strong>連接 MCP 伺服器</strong>
    <span>將 Co-op Translator 工具提供給代理人、編輯者與相容 MCP 的用戶端。</span>
    <em>閱讀指南 -></em>
  </a>
</div>