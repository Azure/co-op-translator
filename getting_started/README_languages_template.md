# ?åê Multi-Language Support (Template)

Maintainers: The block below is an "all languages" example managed by Co?ëop Translator.

- If you want Co?ëop Translator to keep this list fully up?ëto?ëdate automatically when you run `translate` (any language selection), keep the two comment markers as-is.
- If you only want to show a subset of languages, delete the two comment markers and remove any languages you don't want to list. After removing the markers, Co?ëop Translator will no longer auto?ëreplace this section.
