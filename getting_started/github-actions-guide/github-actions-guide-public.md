...
| :---------------------------------- | :---------------------------------------- | :------------------------------- |
| `AZURE_AI_SERVICE_API_KEY`            | Key for Azure AI Vision image translation   | Your Azure AI Foundry               |
| `AZURE_AI_SERVICE_ENDPOINT`         | Endpoint for Azure AI Vision image translation | Your Azure AI Foundry               |
...
| `OPENAI_CHAT_MODEL_ID`              | Specific OpenAI model ID (required when using OpenAI) | Your OpenAI Platform              |
