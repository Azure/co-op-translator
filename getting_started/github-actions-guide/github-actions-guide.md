...
1. After installation redirects you, navigate back to the App's settings page if necessary (GitHub Settings -> Developer settings -> GitHub Apps -> Co-op Translator -> Configure).

1. Under "App settings", note down the **App ID**.

    ![App ID](../../imgs/retrieve-app-id.png)

1. Under "Private keys", click **Generate a private key**. A .pem file will be downloaded. **Save this file securely**.
