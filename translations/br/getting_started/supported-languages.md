...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-06T17:47:56+00:00",
...
A tabela abaixo lista as linguagens atualmente suportadas pelo **Co-op Translator**. Ela inclui os códigos das línguas, os nomes e quaisquer problemas conhecidos associados a cada uma. Se você quiser adicionar suporte para uma nova língua, adicione o código, o nome e a fonte apropriada no arquivo `font_language_mappings.yml` localizado em `src/co_op_translator/fonts/` e envie um pull request após testar.
...
Para adicionar suporte a uma nova língua:
...
2. Adicione o código da língua, o nome e o arquivo de fonte apropriado. Certifique-se de incluir o atributo `rtl` se a língua for escrita da direita para a esquerda.
3. Se precisar usar uma nova fonte, verifique se ela é gratuita para uso em projetos open-source conferindo sua licença e direitos autorais. Após a verificação, adicione o arquivo de fonte no diretório `src/co_op_translator/fonts/`.
4. Teste suas alterações localmente para garantir que a nova língua está suportada corretamente.
5. Envie um Pull Request com suas alterações e indique a adição da nova língua na descrição do PR.
