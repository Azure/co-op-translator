...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-15T04:42:59+00:00",
...
Συντηρητές: Το παρακάτω μπλοκ είναι ένα παράδειγμα "όλων των γλωσσών" που διαχειρίζεται το Co‑op Translator.

- Αν θέλετε το Co‑op Translator να διατηρεί αυτή τη λίστα πλήρως ενημερωμένη αυτόματα όταν εκτελείτε `translate -l "all"`, κρατήστε τα δύο σχόλια ως έχουν.
- Αν θέλετε να εμφανίζεται μόνο ένα υποσύνολο γλωσσών, διαγράψτε τα δύο σχόλια και αφαιρέστε όσες γλώσσες δεν θέλετε να εμφανίζονται. Μετά την αφαίρεση των σχολίων, το Co‑op Translator δεν θα αντικαθιστά πλέον αυτό το τμήμα αυτόματα.
