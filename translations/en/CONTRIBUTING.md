...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-06T17:19:41+00:00",
...
> #### GitHub Codespaces
>
> You can run these samples virtually using GitHub Codespaces without any additional settings or setup required.
>
...
We use [Black](https://github.com/psf/black) as our Python code formatter to maintain consistent code style across the project. Black is an uncompromising code formatter that automatically reformats Python code to follow the Black style.
