...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-06T17:27:18+00:00",
...
| Type                  | Nom                            |
|-----------------------|--------------------------------|
| Modèle de Langage     | ![Azure OpenAI](https://img.shields.io/badge/Azure_OpenAI-blue?style=flat-square) ![OpenAI](https://img.shields.io/badge/OpenAI-green?style=flat-square&logo=openai) |
...
Les barrières linguistiques freinent considérablement l’accès aux ressources éducatives précieuses et aux connaissances techniques pour les apprenants et développeurs du monde entier. Cela limite la participation et ralentit le rythme de l’innovation et de l’apprentissage à l’échelle globale.

**Co-op Translator** est né du besoin de résoudre le processus manuel inefficace de traduction pour les grandes séries éducatives de Microsoft (comme les guides « For Beginners »). Il est devenu un outil puissant et facile à utiliser, conçu pour éliminer ces barrières pour tous. En fournissant des traductions automatisées de haute qualité via la CLI et GitHub Actions, Co-op Translator permet aux éducateurs, étudiants, chercheurs et développeurs du monde entier de partager et d’accéder au savoir sans contraintes linguistiques.
...
Co-op Translator aide à combler le fossé linguistique pour les initiatives éducatives clés de Microsoft, en automatisant la traduction des dépôts qui desservent une communauté mondiale de développeurs. Parmi les projets utilisant actuellement Co-op Translator :
...
- **Traductions Automatisées** : Traduisez facilement du texte dans plusieurs langues.
- **Intégration GitHub Actions** : Automatisez les traductions dans votre pipeline CI/CD.
- **Conservation du Markdown** : Maintenez la syntaxe Markdown correcte lors de la traduction.
- **Traduction du Texte dans les Images** : Extraire et traduire le texte contenu dans les images.
- **Technologie LLM Avancée** : Utilisez des modèles de langage de pointe pour des traductions de qualité.
...
Co-op Translator prend les fichiers Markdown et les images de votre dossier projet et les traite comme suit :
...
Démarrez rapidement avec la CLI ou configurez une automatisation complète avec GitHub Actions.
...
- Guides :
  - [Guide GitHub Actions (Dépôts Publics & Secrets Standards)](./getting_started/github-actions-guide/github-actions-guide-public.md) - Utilisez ce guide pour la plupart des dépôts publics ou personnels s’appuyant sur les secrets standards du dépôt.
...
> [!NOTE]
> Bien que ce tutoriel se concentre sur les ressources Azure, vous pouvez utiliser n’importe quel modèle de langue pris en charge dans la liste des [modèles et services pris en charge](../..).
...
- [Mode Markdown Uniquement](./getting_started/markdown-only-mode.md) : Comment traduire uniquement le texte, sans traduction d’images.
...
- **Microsoft Reactor** : Un guide détaillé d’une heure, étape par étape, couvrant tout, de la compréhension de Co-op Translator, à la configuration de l’outil, son utilisation efficace, ainsi qu’une démonstration en direct montrant ses capacités en action.
...
Rejoignez-nous pour révolutionner la manière dont le contenu éducatif est partagé dans le monde ! Donnez un ⭐ à [Co-op Translator](https://github.com/azure/co-op-translator) sur GitHub et soutenez notre mission de lever les barrières linguistiques dans l’apprentissage et la technologie. Votre intérêt et vos contributions ont un impact important ! Les contributions de code et suggestions de fonctionnalités sont toujours les bienvenues.

## Contribution

Ce projet accueille contributions et suggestions. Vous souhaitez contribuer à Azure Co-op Translator ? Veuillez consulter notre [CONTRIBUTING.md](./CONTRIBUTING.md) pour connaître les directives et savoir comment aider à rendre Co-op Translator plus accessible.
...
Microsoft s’engage à aider ses clients à utiliser ses produits d’IA de manière responsable, en partageant nos enseignements et en construisant des partenariats basés sur la confiance grâce à des outils comme Transparency Notes et Impact Assessments. Beaucoup de ces ressources sont disponibles sur [https://aka.ms/RAI](https://aka.ms/RAI).  
