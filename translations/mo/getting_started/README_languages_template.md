...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-30T13:23:48+00:00",
...
- 如果你希望 Co‑op Translator 在執行 `translate -l "all"` 時自動保持此清單最新，請保留這兩個註解標記不變。
- 如果你只想顯示部分語言，請刪除這兩個註解標記，並移除不想列出的語言。移除標記後，Co‑op Translator 將不會再自動替換此區段。
