...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-30T10:15:17+00:00",
...
以下表格列出目前 **Co-op Translator** 支援的語言。包括語言代碼、語言名稱，以及每種語言已知的問題。如果您想新增支援的語言，請在 `src/co_op_translator/fonts/` 目錄下的 `font_language_mappings.yml` 檔案中加入相應的語言代碼、名稱及合適的字型，並在測試後提交拉取請求。
...
| pa       | 旁遮普文 (古魯穆奇體)  | NotoSansGurmukhi-Medium.ttf      | 否         | 無       |
...
| te       | 泰盧固文               | NotoSans-Medium.ttf              | 否         | 無       |
| ml       | 馬拉雅拉姆文           | NotoSans-Medium.ttf              | 否         | 無       |
| kn       | 卡納達文               | NotoSans-Medium.ttf              | 否         | 無       |

## 新增語言

有興趣新增語言嗎？請參考貢獻指南：

- 請參閱貢獻說明：[貢獻新語言](../CONTRIBUTING.md#contribute-a-new-language)
