...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-30T10:22:51+00:00",
...
下表列出目前 **Co-op Translator** 支援的語言，包括語言代碼、語言名稱，以及每種語言已知的問題。如果您想新增支援的語言，請在 `src/co_op_translator/fonts/` 目錄下的 `font_language_mappings.yml` 檔案中加入對應的語言代碼、名稱及適用字型，並在測試完成後提交 pull request。
...
- 請參閱貢獻說明：[新增語言貢獻](../CONTRIBUTING.md#contribute-a-new-language)
