...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-15T04:43:42+00:00",
...
Người quản lý: Khối bên dưới là ví dụ "tất cả các ngôn ngữ" được quản lý bởi Co‑op Translator.

- Nếu bạn muốn Co‑op Translator tự động cập nhật danh sách này đầy đủ khi chạy `translate -l "all"`, hãy giữ nguyên hai dấu chú thích.
- Nếu bạn chỉ muốn hiển thị một số ngôn ngữ nhất định, hãy xóa hai dấu chú thích và loại bỏ các ngôn ngữ bạn không muốn liệt kê. Sau khi xóa các dấu chú thích, Co‑op Translator sẽ không tự động thay thế phần này nữa.
