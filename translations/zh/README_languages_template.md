...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-15T04:41:32+00:00",
...
维护者：下面的区块是由 Co‑op Translator 管理的“所有语言”示例。

- 如果你希望 Co‑op Translator 在运行 `translate -l "all"` 时自动保持此列表的最新状态，请保持这两个注释标记不变。
- 如果你只想显示部分语言，请删除这两个注释标记，并移除你不想列出的语言。删除标记后，Co‑op Translator 将不再自动替换此部分。
